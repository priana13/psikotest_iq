                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body text-right">
                                 <button id="finish" type="button" class="btn btn-primary text-right" wire:click="seSelesai({{$test_id}})" style="display: none;">NEXT</button>
                                 <button id="finish_" type="button" class="btn btn-primary text-right" onclick="confirm('Apakah anda ingin berpindah ke test tahap selanjutnya ? ')||event.stopImmediatePropagation()" wire:click="seSelesai({{$test_id}})" >NEXT</button>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body text-center">     
                                    @if($NormaSe['file_petunjuk'])                               
                                     <img src="{{ url('storage/photos/'.$NormaSe['file_petunjuk'])}}" alt="no image" style="width: 100%;height: auto;"> 
                                     @endif
                                </div>
                                <div class="card-body text-center">   
                                ...
                                <div class="card-body text-right text-center"> 
                                    <button type="button" class="btn btn-primary btn-lg text-right" wire:click="seMulai({{$test_id}})">
                                        NEXT
                                    </button>
                                </div>
                            </div>
