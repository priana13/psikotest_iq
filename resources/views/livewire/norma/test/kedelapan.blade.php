                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <button id="finish"  type="button" class="btn btn-primary text-right" wire:click="wuSelesai({{$test_id}})" >NEXT</button>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body text-center">     
                                    @if($NormaWu['file_petunjuk'])                               
                                     <img src="{{ url('storage/photos/'.$NormaWu['file_petunjuk'])}}" alt="no image" > 
                                     @endif
                                </div>
                                <div class="card-body">   
                                    <p>JIKA ANDA SUDAH SIAP SILAHKAN KLIK TOMBOL</p>                                    
