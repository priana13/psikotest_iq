        ...
        <div class="col-md-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary text-center"><strong>{{$nama??'NORMA TEST ME - 09'}}</strong></h5>
                </div>
                ...
                <div class="card-footer">
                    <button type="button" class="btn btn-primary" wire:click="simpanTestMe"><i class="fas fa-save"></i>Simpan</button>
                </div>
            </div>
        </div>        
    </div> 
