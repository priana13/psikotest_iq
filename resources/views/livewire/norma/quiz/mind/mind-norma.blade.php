        ...
        <div class="col-md-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary text-center"><strong>{{$nama??'NORMA TEST ME - Mind'}}</strong></h5>
                </div>
                   ...
                   <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-control" >
                            ...
                            <input type="button" wire:click="hapusImgTestMind" value="Hapus Gambar" />
                        </div>
                        @error('file_petunjuk') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>                  
                </div>
                <div class="card-footer">
                    <button type="button" class="btn btn-primary" wire:click="simpanTestMind"><i class="fas fa-save"></i>Simpan</button>
                </div>
            </div>
        </div>        
    </div> 
