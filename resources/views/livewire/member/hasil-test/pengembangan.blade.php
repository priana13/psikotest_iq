    ...
    <div class="row" >     
        ...
        <div class="col m-auto p-3" style="max-width: 1024px;" id="halaman">
            ...
            <div class="card bg-white shadow p-5" >               
                ...
                <h3 class="text-center"> <strong>HASIL TES {{ strtoupper($examevent->exam->nama_tes)  }}</strong> </h3>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr class="font-weight-bold">
                                <td class="text-center"> {{ ($examevent->exam->halaman_penilaian == 'kecerdasan') ? "1-49" : "1-149" }} </td> 
                                <td class="text-center">{{ ($examevent->exam->halaman_penilaian == 'kecerdasan') ? "50-60" : "150-160" }}</td>                               
                                <th class="text-center"> {{ ($examevent->exam->halaman_penilaian == 'kecerdasan') ? "61-79" : "161-179" }}</th>
                                <th class="text-center"> <span>{{ ($examevent->exam->halaman_penilaian == 'kecerdasan') ? "80-100" : "180-200" }}</span> </th>
                            </tr>                          
                        </tbody>
