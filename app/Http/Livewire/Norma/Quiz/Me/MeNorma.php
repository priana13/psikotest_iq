...
class MeNorma extends Component
{
    use WithFileUploads;
    ...
    public function mount(){     
        ...
        $this->nama = optional($this->test)->nama ?? 'INTELLIGENCE STRUCTURE TEST ME - 09';
    ...
    {        
        return view('livewire.norma.quiz.me.me-norma');
    }
}
