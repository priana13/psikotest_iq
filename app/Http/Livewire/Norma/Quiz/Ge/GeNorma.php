...
class GeNorma extends Component
{
    use WithFileUploads;
    ...
    public function mount(){     
        ...
        $this->nama = optional($this->test)->nama ?? 'INTELLIGENCE STRUCTURE TEST GE - 04';
    ...
    {        
        return view('livewire.norma.quiz.ge.ge-norma');
    }
}
