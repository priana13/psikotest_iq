...
class AnNorma extends Component
{
    use WithFileUploads;
    ...
    public function simpanTestAn(){
        //$this->prompt = "Prompt dari simpanTest";
        $img_petunjuk = null;        
    ...
    public function hapusImgTestAn(){    
    ...
    public function mount(){     
        ...
        $this->nama = optional($this->test)->nama ?? 'INTELLIGENCE STRUCTURE TEST AN - 03';
    ...
    {        
        return view('livewire.norma.quiz.an.an-norma');
    }
}
