...
class SeNorma extends Component
{
    use WithFileUploads;
    ...
    public function mount(){     
        ...
        $this->nama = optional($this->test)->nama ?? 'INTELLIGENCE STRUCTURE TEST SE - 01';
    ...
    {        
        return view('livewire.norma.quiz.se.se-norma');
    }
}
