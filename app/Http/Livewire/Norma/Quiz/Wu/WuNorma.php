...
class WuNorma extends Component
{
    use WithFileUploads;
    ...
    public function mount(){     
        ...
        $this->nama = optional($this->test)->nama ?? 'INTELLIGENCE STRUCTURE TEST WU - 08';
    ...
    {        
        return view('livewire.norma.quiz.wu.wu-norma');
    }
}
