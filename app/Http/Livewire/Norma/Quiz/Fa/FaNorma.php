...
class FaNorma extends Component
{
    use WithFileUploads;
    ...
    public function mount(){     
        ...
        $this->nama = optional($this->test)->nama ?? 'INTELLIGENCE STRUCTURE TEST FA - 07';
    ...
    {        
        return view('livewire.norma.quiz.fa.fa-norma');
    }
}
